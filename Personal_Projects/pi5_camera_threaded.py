#!/usr/bin/env python3
"""
Threaded Pi 5 Camera Streaming System
Handles 3 cameras with proper threading to avoid resource conflicts
"""
...
CAMERAS = {
    ...
    4: {"name": "Wide Angle", "device": 4, "rotation": 90, "flip": False}
}
...
def get_camera_device(camera_index):
    ...
    for dev in [device, device + 1, device - 1, 0, 1, 2]:
        if dev < 0:
            continue
        try:
...
@app.route('/')
def index():
    """Main page with threaded camera interface"""
    return '''
    <!DOCTYPE html>
    <html>
    <head>
        <title>Pi 5 Threaded Camera Streaming</title>
        <style>
            body { 
    ...
    <body>
        <div class="header">
            <h1>🦎 Pi 5 Threaded Camera Streaming</h1>
            <p>Gecko Detection System - Multi-threaded Camera Support</p>
        </div>

        <div class="status">
            <h3>📊 System Status</h3>
            <p>Camera Streaming: <span style="color: #27ae60;">✅ Threaded</span> |
               Resource Management: <span style="color: #27ae60;">✅ Optimized</span> |
               Performance: <span style="color: #27ae60;">✅ Stable</span> |
               Multi-Camera: <span style="color: #27ae60;">✅ Supported</span></p>
        </div>
        ...
        <script>
            // Auto-refresh images every 5 seconds (more stable with threading)
...
if __name__ == '__main__':
    print("🚀 Starting Threaded Pi 5 Camera Streaming...")
    print("📹 Camera Threads:")
    print("   - Camera 0: Main Habitat (device 0)")
    print("   - Camera 2: Secondary View (device 2)")
    print("   - Camera 4: Wide Angle (device 4)")
    print("🔧 Features:")
    print("   - Multi-threaded camera capture")
    print("   - Thread-safe frame buffers")
    print("   - Resource conflict prevention")
    print("   - Automatic device detection")
    print("   - Fallback to test patterns")
    ...
    print("🎬 Threaded camera system ready!")
