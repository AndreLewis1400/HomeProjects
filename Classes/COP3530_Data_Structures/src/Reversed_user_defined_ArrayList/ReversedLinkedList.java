...
public class ReversedLinkedList<AnyType> {
 ...
 // Removes the last element from the ArrayList
    ...
    public void reverse() {
    	...
    	while (start < end) {
    		// Swap items [start] and items [end]
    		AnyType temp = items[start];
    		items[start] = items[end];
    		items[end] = temp;
    		 		
    		start++; // Increment start to move forward
    		end--; // Decrement end to move backward
    	}	
    }
